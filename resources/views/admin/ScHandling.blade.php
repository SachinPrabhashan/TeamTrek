...
@section('content')
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        var existingRow = $('#example tbody tr').filter(function() {
                            return $(this).find('td:first').text() == response
                                .support_contract.id;
                        });

                        // If the row exists, update its content
                        if (existingRow.length > 0) {
                            existingRow.find('td:eq(1)').text(response.support_contract
                            .user_id);
                            existingRow.find('td:eq(2)').text(response.support_contract.name);
                            existingRow.find('td:eq(3)').text(response.support_contract
                                .company_name);
                        } else {
    ...
    <div class="container col-12">
        <div class="bg-light rounded h-100 p-4">
            <div class="container-fluid">
                ...
                <div class="float-end">
                    @RootOrAdmin
                        <button class="btn btn-primary" id="addSupportContractBtn"data-toggle="tooltip"
                            data-bs-placement="bottom" title="Create Support Contract">
                                            ...
                                            <div class="d-inline-block mx-1">
                                                <a href="#">
                                                    <i class="fa-solid fa-pen-to-square"
                                                        style="color: green;"data-toggle="tooltip" data-bs-placement="bottom"
                                                        title="Edit Support Contract"></i>
                                                </a>
                                            </div>
                                            ...
                                            <div class="d-inline-block mx-1">
                                                <a href="#">
                                                    <i class="fa-solid fa-circle-info"
                                                        ...
                                                        title="Disable Support Contract"></i>
                                                </a>
                                            </div>
                                        </td>
                                    @endRootOrAdmin
    ...
    <!-- Add Modal -->
    <div class="modal fade" id="addSupportContractModal" data-easein="flipYin" tabindex="-1"
    ...
    <!-- Edit Modal -->
    <div class="modal fade" id="editSupportContractModal" tabindex="-1" aria-labelledby="editSupportContractModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
