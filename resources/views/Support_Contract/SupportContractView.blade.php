    ...
    <div class="container col-12">
        <div class="bg-light rounded h-100 p-4">
            ...
            <div class="rolebtn bg-light rounded h-100 p-4">
                ...
                <button class="btn btn-primary m-2" id="taskViewSearchBtn" data-toggle="tooltip"
                    title="Search SC View">Search
            ...
            <div id="loadingAnimation" class="mt-4 text-center">
                <img src="{{ asset('img/Graph01Animation.gif') }}" alt="Loading Animation"
            ...
            $(document).ready(function() {
                ...
                function displayChart(chartData) {
                    ...
                    devChart = new Chart(ctxDev, {
                        type: 'pie',
                        data: {
                            labels: [devHoursRemaining !== null ? (devHoursRemaining === SupportdevHours ?
                                    'Dev Hours Used' : 'Remaining Dev Hours') : 'Remaining Dev Hours',
                                'Used Dev Hours'
                            ],
                            datasets: [{
                                label: 'Developer Hours',
                                data: [devHoursRemaining !== null ? devHoursRemaining : SupportdevHours,
                                    devHoursRemaining !== null ? devHoursDifference : 0
                                ],
                                backgroundColor: ['#007bff',
                                    '#28a745'
                                ], // Blue for Used, Green for Remaining
                            }]
                        }
                    });
                    ...
                    engChart = new Chart(ctxEng, {
                        type: 'pie',
                        data: {
                            labels: [engHoursRemaining !== null ? (engHoursRemaining === SupportengHours ?
                                    'Eng Hours Used' : 'Remaining Eng Hours') : 'Remaining Eng Hours',
                                'Used Eng Hours'
                            ],
                            datasets: [{
                                label: 'Engineer Hours',
                                data: [engHoursRemaining !== null ? engHoursRemaining : SupportengHours,
                                    engHoursRemaining !== null ? engHoursDifference : 0
                                ],
                                backgroundColor: ['#ff5733',
                                    '#ffc300'
                                ], // Red for Used, Yellow for Remaining
                            }]
                        }
                    });
                }
